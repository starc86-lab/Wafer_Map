...
# FHD 0.75 → 0.85 (사용자 정책 2026-05-03) — 0.75 × 288 (소 그래프) = 216 logical px
# 가 layout 공간 한계 근접 → Settings 변경 시 paint deferred 회귀 다발. 0.85 로
# 약간 키워 245 logical px 확보. UHD 1.3 도 작은 모니터 호환성 위해 유지.
UI_MODE_SCALE = {"FHD": 0.85, "QHD": 1.0, "UHD": 1.3}
...
DEFAULT_SETTINGS = {
    ...
    # 360° 회전으로 강제 radial 처리. collinear 자동 감지 데이터는 영향 없음.
    "r_symmetry_mode": False,
